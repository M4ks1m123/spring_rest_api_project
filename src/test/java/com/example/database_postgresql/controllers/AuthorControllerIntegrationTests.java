...
public class AuthorControllerIntegrationTests {
    ...
    @Test
    public void testThatGetAuthorReturnsHAuthorWhenAuthorExists() throws Exception {
        AuthorEntity testAuthorEntityA = TestDataUtil.createTestAuthorEntityA();
        authorService.save(testAuthorEntityA);
    ...
    @Test
    public void testThatDeleteAuthorReturnHttpsStatus204ForNonExistingAuthor() throws Exception {
    ...
    @Test
    public void testThatDeleteAuthorReturnHttpsStatus204ForExistingAuthor() throws Exception {
        AuthorEntity testAuthorEntityA = TestDataUtil.createTestAuthorEntityA();
        AuthorEntity savedAuthor = authorService.save(testAuthorEntityA);
